...
namespace PhenologyMaizeCrop2ML.Strategies
{
    class CalculateLeafNumber : PhenologyCrop2MLiStrategy
    {
        ...
        public CalculateLeafNumber()
        {
            ...
            pd0.PropertyName = "AllTTLeavesCalculated";
            pd0.PropertyType = ((PhenologyMaizeCrop2MLStateVarInfo.AllTTLeavesCalculated)).ValueType.TypeForCurrentValue;
            pd0.PropertyVarInfo = (PhenologyMaizeCrop2MLStateVarInfo.AllTTLeavesCalculated);
            _inputs0_0.Add(pd0);
            PropertyDescription pd25 = new PropertyDescription();
            pd25.DomainClassType = typeof(PhenologyMaizeCrop2MLState);
            pd25.PropertyName = "Ntip";
            pd25.PropertyType = ((PhenologyMaizeCrop2MLStateVarInfo.Ntip)).ValueType.TypeForCurrentValue;
            pd25.PropertyVarInfo = (PhenologyMaizeCrop2MLStateVarInfo.Ntip);
            _inputs0_0.Add(pd25);
        ...
        private void CalculateModel(PhenologyMaizeCrop2MLState s, PhenologyMaizeCrop2MLState s1, PhenologyMaizeCrop2MLRate r, PhenologyMaizeCrop2MLAuxiliary a, PhenologyMaizeCrop2MLExogenous ex)
        {
            ...
            int AllTTLeavesCalculated = 0;


            double Ntip = Ntip_t1;
            double LeafNumber = LeafNumber_t1;
            double LNlig = LNlig_t1;
            double LNfullyexp = LNFullyExp_t1;
